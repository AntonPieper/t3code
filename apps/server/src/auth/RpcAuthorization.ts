...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.previewClaimHost]: AuthOrchestrationOperateScope,
  [WS_METHODS.previewStartServer]: AuthOrchestrationOperateScope,
  [WS_METHODS.previewStopServer]: AuthOrchestrationOperateScope,
  [WS_METHODS.previewRestartServer]: AuthOrchestrationOperateScope,
  [WS_METHODS.previewServerEvents]: AuthOrchestrationReadScope,
  [WS_METHODS.previewVerificationEvents]: AuthOrchestrationReadScope,
  [WS_METHODS.previewVerificationSet]: AuthOrchestrationOperateScope,
  [WS_METHODS.previewVerificationCancel]: AuthOrchestrationOperateScope,
  [WS_METHODS.previewCreatePortGateway]: AuthOrchestrationOperateScope,
